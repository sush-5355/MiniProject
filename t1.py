...
# # Create ASCII art text for "Time Zones" using the "block" font
# text = text2art("Time Zones", font="block")
...
# # Create a styled ASCII art "Time Zones" banner
# banner = pyfiglet.figlet_format("Time Zones", font="block")

# # Print the banner in a stylish color
# print(colored(banner, "blue"))

# # Display each time zone with a different color
# for idx, timezone in enumerate(timezones, start=1):
#     color = "green" if idx % 2 == 0 else "yellow"  # Alternating colors for fun
#     print(colored(timezone, color))

# # Optionally, add a closing message
# print(colored("Enjoy exploring the time zones!", "blue"))


# def paginate_list(input_list, items_per_page):
#     for i in range(0, len(input_list), items_per_page):
#         yield input_list[i:i + items_per_page]
...
#     page_end = current_page * items_per_page
#     for idx,timezone in enumerate(timezones[page_start:page_end]):
#         print(idx,' - ',timezone)

#     if current_page < len(timezones) // items_per_page:
#         choice = input("Press Enter for the next page, or enter a page number to jump to: ")
#         if choice.isdigit():
#             page_num = int(choice)
#             if 1 <= page_num <= len(timezones) // items_per_page + 1:
...
timezones_with_abbreviations = []

for timezone in all_timezones:
    tz = pytz.timezone(timezone)
    abbreviation = tz.tzname(None)
    timezones_with_abbreviations.append((timezone, abbreviation))

# Sort the list by timezone name
timezones_with_abbreviations.sort()
lst = []
dic = {}
# Print the list of timezones with abbreviations
# for timezone, abbreviation in timezones_with_abbreviations:
#     dic['timezone'] = timezone
#     dic['abbreviation'] = abbreviation
#     lst.append(dic)
    # print(f"Timezone: {timezone}, Abbreviation: {abbreviation}")
import pandas as pd
df = pd.DataFrame(timezones_with_abbreviations)
print(df.head(10))
